...
module Material.Icons.Directory.J exposing
    ( jeepney
    , jellyfish
    , jellyfishOutline
    , jumpRope
...
{-| Look up an icon (which has the first letter "j") by its name.
